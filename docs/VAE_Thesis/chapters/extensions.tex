...
Finally, in the field of drug discovery, \cite{li_multi_2018} utilize conditional graph generative models for multi-objective de novo design, identifying the \ac{SSVAE} framework as a promising extension to further enhance their generative capabilities.
