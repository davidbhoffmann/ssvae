...
The presentation of the \ac{SSVAE} framework in \cite{narayanaswamy_learning_2017}, while correct, at points, leaves the reader guessing at specific details, disrupting the reading flow. For example the variable $n$ is never defined. It comes up in the relationship
\begin{equation}
