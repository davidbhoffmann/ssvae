...
Note, that during the review process we found that most derivate work builds on the original \ac{SSVAE} of \cite{kingma_semi-supervised_2014} with 4094 citations on google scholar while \cite{narayanaswamy_learning_2017} are cited 445 times.
