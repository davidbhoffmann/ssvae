...
The final test \ac{ELBO} remains relatively constant with respect to $\alpha$, which can also be seen in \autoref{apx:training}. A minor increase of the \ac{ELBO} can be observed wit increasing $\alpha$. The results further show that for the unsupervised $z$, stronger supervision decreases disentanglement.
...
Similar to the the supervision weight experiments, the final test \ac{ELBO} remains relatively constant. However, a marginal \ac{ELBO} drop with increased corruption rates is noticeable across configurations. The results further show that for the unsupervised $z$, more label corruption in $y$ decreases disentanglement. 
