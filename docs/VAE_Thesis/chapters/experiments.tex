...
For the evaluation, we use accuracy to assess whether the semi-supervised latent $y$ is correctly learned. To evaluate the unsupervised latents, we utilize three metrics that assess disentanglement through different information-theoretic lenses.
